...
public class CyanogenSettingsPage extends SetupPage {
    ...
    public static final String LYCAN_COMMUNITY_URI = "https://plus.google.com/communities/109330559573276360638";
    ...
    public int getTitleResId() {
        return R.string.setup_lycan_services;
    }
    ...
    public static class CyanogenSettingsFragment extends SetupPageFragment {
        ...
        protected void initializePage() {
            ...
            String lycan_community = getString(R.string.lycan_community);
            String lycanSummary = getString(R.string.general_explanation, lycan_community);
            SpannableString ss = new SpannableString(lycanSummary);
            ClickableSpan clickableSpan = new ClickableSpan() {
                @Override
                public void onClick(View textView) {
                    final Intent intent = new Intent(SetupWizardApp.ACTION_VIEW_LEGAL);
                    intent.setData(Uri.parse(LYCAN_COMMUNITY_URI));
                    try {
            ...
            ss.setSpan(clickableSpan,
                    lycanSummary.length() - lycan_community.length() - 1,
                    lycanSummary.length() - 1, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            TextView privacyPolicy = (TextView) mRootView.findViewById(R.id.lycan_community);
